...
export const metadata: Metadata = {
  title: "Sobre mí",
  description: "Soy Anna Álvarez, event & wedding planner en Barcelona y Catalunya. Acompaño a parejas en uno de los momentos más bonitos de su vida.",
};

const valores = [
  { t: "Acompañamiento real", b: "Trabajo con pocas parejas al año para poder estar de verdad en cada proyecto, no a medio gas." },
  { t: "Autenticidad", b: "No hago bodas de Pinterest. Cada celebración nace de lo que sois, de lo que os emociona, de vuestra historia." },
  { t: "Calma e intención", b: "Mi trabajo es que disfrutéis del proceso. Que planear vuestra boda sea tan bonito como vivirla." },
];
    ...
    <main>
      <section style={{ position: "relative", minHeight: "60vh", display: "flex", alignItems: "flex-end", overflow: "hidden", background: "var(--ink)", padding: "150px clamp(20px,6vw,88px) clamp(52px,6vw,88px)" }}>
        ...
        <div style={{ position: "relative", zIndex: 3, maxWidth: 760 }}>
          ...
          <h1 className="serif" style={{ fontSize: "clamp(38px,5.4vw,80px)", fontWeight: 400, color: "#fff", lineHeight: 1.06, margin: 0, letterSpacing: ".5px" }}>La persona detrás<br />de vuestra tranquilidad</h1>
        </div>
      </section>
        ...
        <div className="wrap g-two">
          <div style={{ position: "relative" }}>
            ...
            <div style={{ position: "relative", zIndex: 1, aspectRatio: "4/5", overflow: "hidden" }}>
              <Image src="/photos/p8.jpg" alt="Anna Álvarez, wedding planner" fill sizes="(min-width:860px) 40vw, 100vw" style={{ objectFit: "cover", objectPosition: "center top" }} />
            </div>
          </div>
          <div>
            ...
            <p className="sans" style={{ fontSize: 15.5, color: "var(--ink-soft)", lineHeight: 1.85, margin: "0 0 18px" }}>Soy Anna Álvarez, event & wedding planner en Barcelona y Catalunya. Lo que más me apasiona es acompañar a parejas en uno de los momentos más importantes de su vida, cuidando cada detalle con intención.</p>
            <p className="sans" style={{ fontSize: 15.5, color: "var(--ink-soft)", lineHeight: 1.85, margin: "0 0 18px" }}>No busco bodas perfectas de revista. Busco celebraciones auténticas donde cada elemento cuente vuestra historia. Donde al entrar digáis: esto somos nosotros.</p>
            <p className="sans" style={{ fontSize: 15.5, color: "var(--ink-soft)", lineHeight: 1.85, margin: 0 }}>DLC es para ti si quieres que alguien cuide tu viaje emocional, no solo la logística. Si buscas celebrar con alma, con calma y con intención.</p>
            <p className="script" style={{ fontSize: 32, color: "var(--coral)", margin: "26px 0 0" }}>Anna</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "var(--coral-bg)", padding: "clamp(64px,8vw,120px) clamp(20px,6vw,88px)", textAlign: "center" }}>
        <h2 className="serif" style={{ fontSize: "clamp(28px,3.6vw,48px)", fontWeight: 400, color: "var(--ink)", margin: "0 0 26px", fontStyle: "italic" }}>Yo gestiono el caos, vosotros levantáis la copa.</h2>
