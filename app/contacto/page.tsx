...
export const metadata: Metadata = {
  title: "Contacto",
  description: "Escribeme y te respondo personalmente. Empezamos con una conversacion tranquila, sin compromiso, para conocernos y ver como puedo acompanaros.",
};
    ...
    <main>
      <section className="g-split" style={{ minHeight: "100vh", background: "var(--ink)" }}>
        ...
        <div style={{ order: 2, padding: "clamp(96px,10vw,140px) clamp(24px,5vw,72px) clamp(56px,7vw,88px)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <h1 className="serif" style={{ fontSize: "clamp(30px,3.8vw,52px)", fontWeight: 400, color: "#fff", lineHeight: 1.15, margin: "0 0 18px" }}>Teneis fecha? Hablemos</h1>
          <p className="sans" style={{ fontSize: 15, color: "var(--on-dark-soft)", lineHeight: 1.8, margin: "0 0 34px", fontWeight: 300, maxWidth: "48ch" }}>Escribeme y te respondo personalmente. Sin compromiso, empezamos con una conversacion para conocernos.</p>
